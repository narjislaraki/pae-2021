...
public class FurnitureImpl implements FurnitureDTO {
	...
	public String toString() {
		return "FurnitureImpl [id=" + id + ", typeId=" + typeId + ", type=" + type + ", requestForVisitId="
				+ requestForVisitId + ", sellerId=" + sellerId + ", seller=" + seller + ", condition=" + condition
				+ ", description=" + description + ", purchasePrice=" + purchasePrice + ", pickUpDate=" + pickUpDate
				+ ", storeDeposit=" + storeDeposit + ", depositDate=" + depositDate + ", offeredSellingPrice="
				+ offeredSellingPrice + ", favouritePhotoId=" + favouritePhotoId + ", favouritePhoto="
